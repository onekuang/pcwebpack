...
module.exports = {
	...
	module: {
        ...
        // loader: Ex.extract("style-loader!css-loader!less-loader!postcss-loader")
      },
      {
	...
	plugins: [
	  ...
	  new webpack.optimize.OccurrenceOrderPlugin(),
		...
		new htmlWebpackPlugin({
			...
			filename: 	'index.html', 
			// 模版位置
			template: 'html-withimg-loader!' + __dirname + "/index.htm",  
			// script标签的位置
			inject: 		'true',
			// 指定引用的js, 默认引入所有打包的js
			chunks: [
		...
		// 	title: "列表",
		// 	filename: 	'list.html', 
		// 	template: __dirname + "/view/list/list.htm",  
		// 	// 指定引用的js, 默认引入所有打包的js
		// 	chunks: [
		// 		'main'
		// 	],
